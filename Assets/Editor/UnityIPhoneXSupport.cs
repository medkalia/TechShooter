...
public class UnityIPhoneXSupport {
	...
	private const string leftImage = "left@3x";    // Relative path from "Assets/StreamingAssets/"
	private const string rightImage = "right@3x";    // Relative path from "Assets/StreamingAssets/"
